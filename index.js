...
function initialize() {
   ...
   function makeRedColor(...elems) {
      elems.forEach(element => element.style.color = 'red');
   }

   function makeGreyColor(...elems) {
      elems.forEach(element => element.style.color = 'rgba(0, 0, 0, 0.65)');
   }
}
